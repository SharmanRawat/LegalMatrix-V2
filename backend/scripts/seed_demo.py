...
INSPECTION_CONFIGS = [
    # 1 — Fully compliant milk
    {
        ...
        "radar": {
            ...
            "axes": [
                {"axis": "Declarations", "score": 100, "weight": 0.30},
                {"axis": "Pricing", "score": 95, "weight": 0.20},
                {"axis": "Dates", "score": 100, "weight": 0.10},
                {"axis": "Consumer Care", "score": 100, "weight": 0.10},
                {"axis": "Font Size", "score": 88, "weight": 0.20},
                {"axis": "Readability", "score": 92, "weight": 0.10},
            ],
        },
        "font": {
            "status": "COMPLIANT",
    ...
    # 2 — Non-compliant detergent (missing consumer care, dimensions)
    {
        ...
        "radar": {
            ...
            "axes": [
                {"axis": "Declarations", "score": 57, "weight": 0.30},
                {"axis": "Pricing", "score": 50, "weight": 0.20},
                {"axis": "Dates", "score": 40, "weight": 0.10},
                {"axis": "Consumer Care", "score": 0, "weight": 0.10},
                {"axis": "Font Size", "score": 72, "weight": 0.20},
                {"axis": "Readability", "score": 65, "weight": 0.10},
            ],
        },
        "font": {
            "status": "COMPLIANT",
    ...
    # 3 — Needs review noodles (expiry date format issue)
    {
        ...
        "radar": {
            ...
            "axes": [
                {"axis": "Declarations", "score": 83, "weight": 0.30},
                {"axis": "Pricing", "score": 80, "weight": 0.20},
                {"axis": "Dates", "score": 85, "weight": 0.10},
                {"axis": "Consumer Care", "score": 90, "weight": 0.10},
                {"axis": "Font Size", "score": 65, "weight": 0.20},
                {"axis": "Readability", "score": 72, "weight": 0.10},
            ],
        },
        "font": {
            "status": "REVIEW_REQUIRED",
            ...
            "image_index": 0,
            "implausible": False,
            "box_rejected_reason": "low contrast text region",
        },
        "confidence": {
            "overall": 82,
            "coverage_ratio": 0.80,
    ...
    # 4 — Fully compliant salt
    {
        ...
        "radar": {
            ...
            "axes": [
                {"axis": "Declarations", "score": 100, "weight": 0.30},
                {"axis": "Pricing", "score": 100, "weight": 0.20},
                {"axis": "Dates", "score": 100, "weight": 0.10},
                {"axis": "Consumer Care", "score": 100, "weight": 0.10},
                {"axis": "Font Size", "score": 95, "weight": 0.20},
                {"axis": "Readability", "score": 98, "weight": 0.10},
            ],
        },
        "font": {
            "status": "COMPLIANT",
    ...
    # 5 — Violation: oil missing MRP symbol
    {
        ...
        "radar": {
            "overall": 42.8,
            "grade": "D",
            "grade_label": "Critical Violations",
            "axes": [
                {"axis": "Declarations", "score": 43, "weight": 0.30},
                {"axis": "Pricing", "score": 20, "weight": 0.20},
                {"axis": "Dates", "score": 30, "weight": 0.10},
                {"axis": "Consumer Care", "score": 60, "weight": 0.10},
                {"axis": "Font Size", "score": 75, "weight": 0.20},
                {"axis": "Readability", "score": 55, "weight": 0.10},
            ],
        },
        "font": {
            "status": "COMPLIANT",
    ...
    # 6 — Compliant toothpaste with manual override
    {
        ...
        "radar": {
            ...
            "axes": [
                {"axis": "Declarations", "score": 100, "weight": 0.30},
                {"axis": "Pricing", "score": 92, "weight": 0.20},
                {"axis": "Dates", "score": 95, "weight": 0.10},
                {"axis": "Consumer Care", "score": 98, "weight": 0.10},
                {"axis": "Font Size", "score": 78, "weight": 0.20},
                {"axis": "Readability", "score": 85, "weight": 0.10},
            ],
        },
        "font": {
            "status": "COMPLIANT",
    ...
    # 7 — Review required antiseptic (font measurement uncertain)
    {
        "product_idx": 6,
        "day_offset": 8,
        "status": "REVIEW_REQUIRED",
        ...
        "radar": {
            ...
            "axes": [
                {"axis": "Declarations", "score": 83, "weight": 0.30},
                {"axis": "Pricing", "score": 85, "weight": 0.20},
                {"axis": "Dates", "score": 90, "weight": 0.10},
                {"axis": "Consumer Care", "score": 95, "weight": 0.10},
                {"axis": "Font Size", "score": None, "weight": 0.0},
                {"axis": "Readability", "score": 70, "weight": 0.10},
            ],
        },
        "font": {
            ...
            "uncertainty": None,
            "required_mm": None,
            "calibration_rejected_reason": "No clear calibration reference found in any image",
        },
        "confidence": {
            "overall": 75,
            "coverage_ratio": 0.80,
    ...
    # 8 — Compliant atta
    {
        ...
        "radar": {
            ...
            "axes": [
                ...
                {"axis": "Dates", "score": 90, "weight": 0.10},
                {"axis": "Consumer Care", "score": 100, "weight": 0.10},
                {"axis": "Font Size", "score": 85, "weight": 0.20},
                {"axis": "Readability", "score": 88, "weight": 0.10},
            ],
        },
        "font": {
            "status": "COMPLIANT",
    ...
    # 9 — Violation: biscuits missing net quantity
    {
        ...
        "radar": {
            ...
            "axes": [
                {"axis": "Declarations", "score": 43, "weight": 0.30},
                {"axis": "Pricing", "score": 70, "weight": 0.20},
                {"axis": "Dates", "score": 80, "weight": 0.10},
                {"axis": "Consumer Care", "score": 85, "weight": 0.10},
                {"axis": "Font Size", "score": None, "weight": 0.0},
                {"axis": "Readability", "score": 60, "weight": 0.10},
            ],
        },
        "font": {
            "status": "CANNOT_MEASURE",
            ...
            "uncertainty": None,
            "required_mm": None,
            "calibration_rejected_reason": "Barcode present but not usable as calibration reference",
        },
        "confidence": {
            "overall": 52,
            "coverage_ratio": 0.55,
    ...
    # 10 — Compliant dishwash (most recent, for "recent inspections")
    {
        ...
        "radar": {
            ...
            "axes": [
                {"axis": "Declarations", "score": 100, "weight": 0.30},
                {"axis": "Pricing", "score": 90, "weight": 0.20},
                {"axis": "Dates", "score": 85, "weight": 0.10},
                {"axis": "Consumer Care", "score": 95, "weight": 0.10},
                {"axis": "Font Size", "score": 70, "weight": 0.20},
                {"axis": "Readability", "score": 80, "weight": 0.10},
            ],
        },
        "font": {
            "status": "COMPLIANT",
